using BookingApp.AppStart.Swagger;
...
namespace BookingApp.AppStart.ConfigureServices
{
    ...
    {
        private const string AppTitle = "Booking API";
        ...
        public static void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            services.AddSwaggerGen(options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo
                {
                    Title = AppTitle,
                    Version = AppVersion,
                    Description = "Web API for Booking App Client"
                });
                ...
                options.SwaggerDoc("v1-admin", new OpenApiInfo
                {
                    Title = AppTitle,
                    Version = AppVersion,
                    Description = "Web API for Booking App Admin"
                });
